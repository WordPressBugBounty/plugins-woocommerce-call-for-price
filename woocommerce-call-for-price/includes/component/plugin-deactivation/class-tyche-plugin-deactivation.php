		...
		public function enqueue_scripts() {
			...
			$data = array(
				'reasons'  => array(
					array(
						'id'                => 1,
						'text'              => __( 'I only needed the plugin for a short period.', 'woocommerce-call-for-price' ),
						'input_type'        => '',
						'input_placeholder' => '',
					),
					array(
						'id'                => 2,
						'text'              => __( 'I found a better plugin.', 'woocommerce-call-for-price' ),
						'input_type'        => 'textfield',
						'input_placeholder' => __( 'Please let us have the plugin\'s name so that we can make improvements', 'woocommerce-call-for-price' ),
					),
					array(
						'id'                => 3,
						'text'              => __( 'The plugin is not working.', 'woocommerce-call-for-price' ),
						'input_type'        => 'textfield',
						'input_placeholder' => __( 'Please share what was faulty with the plugin so that we may get the issue fixed.', 'woocommerce-call-for-price' ),
					),
					array(
						'id'                => 4,
						'text'              => __( 'The plugin is causing issues on my site', 'woocommerce-call-for-price' ),
						'input_type'        => 'textfield',
						'input_placeholder' => __( 'We’re sorry! Please tell us about the issues so that we can get them fixed.', 'woocommerce-call-for-price' ),
					),
					array(
						'id'                => 6,
						'text'              => __( 'Some features I need are not working as per my expectations', 'woocommerce-call-for-price' ),
						'input_type'        => 'textfield',
						'input_placeholder' => __( 'Please tell us about these features.', 'woocommerce-call-for-price' ),
					),
					array(
						'id'                => 7,
						'text'              => __( 'The plugin is not compatible with another plugin/theme', 'woocommerce-call-for-price' ),
						'input_type'        => 'textfield',
						'input_placeholder' => __( 'We’re sorry! We would like you to tell us the plugin/theme so that we can work on the compatibility.', 'woocommerce-call-for-price' ),
					),
					array(
						'id'                => 10,
						'text'              => __( 'Other', 'woocommerce-call-for-price' ),
						'input_type'        => 'textfield',
						'input_placeholder' => '',
					),
				),
								...
								<div class="ts-modal-dialog">
									<div class="ts-modal-body">
										...
										<div class="ts-modal-panel active" data-panel-id="reasons">
											<h3>
												<strong>
													' . __( 'If you have a moment, please let us know why you are deactivating:', 'woocommerce-call-for-price' ) . '
												</strong>
											</h3>
									...
									<div class="ts-modal-footer">
										<a href="javascript:void(0);" class="button button-secondary button-skip-deactivate"> ' . __( 'Skip & Deactivate', 'woocommerce-call-for-price' ) . '</a>
										<a href="javascript:void(0);" class="button button-secondary button-deactivate"> ' . __( 'Submit & Deactivate', 'woocommerce-call-for-price' ) . '</a>
										<a href="javascript:void(0);" class="button button-primary button-close">' . __( 'Cancel', 'woocommerce-call-for-price' ) . '</a>
									</div>
								</div>
							</div>',
			);
			...
			wp_localize_script(
				...
				array(
					...
					'deactivation_req_msg' => __( 'Please select a reason for deactivation!', 'woocommerce-call-for-price' ),
				)
			);

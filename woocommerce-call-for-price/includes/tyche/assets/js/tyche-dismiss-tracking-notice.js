		...
		$button.on( 'click.notice-dismiss', function( event ) {
			...
			$this.fadeTo( 100 , 0, function() {
				...
				jQuery(this).slideUp( 100, function() {
					jQuery(this).remove();				
					jQuery.post(
						cfp_ts_dismiss_notice.ts_admin_url,
						{
							action: cfp_ts_dismiss_notice.ts_prefix_of_plugin + "_tracker_dismiss_notice",
							tracking_notice : cfp_ts_dismiss_notice.tracking_notice,
						},
						function( response ) {}
					);
				});
